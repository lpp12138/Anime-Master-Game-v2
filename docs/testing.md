...
| 首页密钥截图选择/拖放/粘贴、受限直链或 JSON/JSONL 导入、同标题/按 ID 追加（包括结构已人工编辑题库）、答案/标签、图片索引或投稿幂等 | `npm run test:community-screenshot-upload`、`npm run test:r2-upload`、`npm run test:question-set-creation-method` |
